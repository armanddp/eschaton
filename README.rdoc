...
Only gem and thor generator working yet.

Specify gem as requirement in Gemfile:
	$ gem 'eschaton', :git => 'git://github.com/armanddp/eschaton.git', :branch => 'rails3'
	
Generate a map, look at the files the generator created and play a bit:

	$ rails generate eschaton:map
